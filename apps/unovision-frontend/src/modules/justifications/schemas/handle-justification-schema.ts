...
export const handleJustificationSchema = createJustificationSchema
  .omit({ documentLink: true }) // VER POR QUÉ ESTO ES OPCIONAL.
  .extend({
    justificationId: z.uuid().optional(), // Optional for creation, required for edition
...
export type HandleJustificationSchema = z.infer<typeof handleJustificationSchema>;
