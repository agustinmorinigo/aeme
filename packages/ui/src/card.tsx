...
export function Card({
  ...
  return (
    <a
      className="ui:group ui:rounded-lg ui:border ui:border-transparent ui:px-5 ui:py-4 ui:transition-colors hover:ui:border-neutral-700 hover:ui:bg-neutral-800/30 ui:bg-nuevo-8 ui:text-nuevo-3"
